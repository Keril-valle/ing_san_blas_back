...
export class InitialSchema1783826389206 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."usuario_role_enum" AS ENUM('admin', 'user')`,
    );
    await queryRunner.query(
